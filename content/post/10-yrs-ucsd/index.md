...
# Projects (optional). Associate this post with one or more of your projects.
#   Simply enter your project's folder or file name without extension. E.g.
#   `projects = ["internal-project"]` references
#   `content/project/deep-learning/index.md`. Otherwise, set `projects = []`.
#   projects: [cogrob, CRI, avl]

---

On August 8th, 2026 my current and former UCSD graduate students organized a
surprise celebration of my ten years at UC San Diego. This is a short reflection
on a decade in San Diego.

It has been an interesting period. We launched the [Contextual Robotics
...
field is seeing so much growth. 

On the personal research side I have mainly been responsible for two research
labs - [Cognitive Robotics Laboratory](https://cogrob.org) and [Autonomous
Vehicle Laboratory](https://avl.ucsd.edu). CogRob has developed major new
techniques for domestic robotics and multi-robot systems. It was also partly the
basis for the work on
[Open X-Embodiment](https://hichristensen.com/publication/corl-23/), which formed
the basis for Physical Intelligence, SUDO, and Trusted Robot Intelligence (now
...
quality of life is great (but not cheap).
